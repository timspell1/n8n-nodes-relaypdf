    ...
    properties: [
      ...
      },
      {
        ...
        options: [
          ...
          { name: "Merge", value: "merge", action: "Merge PDF files" },
          { name: "Protect", value: "protect", action: "Password protect a PDF" },
          { name: "Raster", value: "raster", action: "Convert PDF pages to images" },
      ...
      },
      {
        ...
        type: "boolean",
        default: false,
        description: "Whether to raster pages and send images when the text layer is missing or weak",
        displayOptions: show("pdf", "data"),
      },
      {
        displayName: "Pages",
